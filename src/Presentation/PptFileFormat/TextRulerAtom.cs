...
{
    [OfficeRecordAttribute(4006)]
    public class TextRulerAtom : Record
    {
        public uint flags;
        ...
        public TextRulerAtom(BinaryReader _reader, uint size, uint typeCode, uint version, uint instance)
    ...
    {
        public uint count;
        public List<TabStop> tabStops = new List<TabStop>();

        public TabStops(BinaryReader reader)
        {
    ...
    public class TabStop
    {
        ...
        public TextTabTypeEnum TabType;
